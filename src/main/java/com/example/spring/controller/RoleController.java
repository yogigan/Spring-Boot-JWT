...
public class RoleController {
    ...
    @PostMapping
    public ResponseEntity<ApiResponse> createRole(@RequestBody AppRole role) {
    ...
    public ResponseEntity<ApiResponse> addToUser(@RequestBody RoleToUserRequest roleToUserRequest) {
